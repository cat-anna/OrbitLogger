...
struct LogLineBuffer {
    ...
    bool Empty() const { return m_LogLineAllocated == 0; }
...
struct LogCollector::LogCollectorImpl {
    ...
    void SetChannelName(LogChannel Channel, const char *Name) { m_LineTypeTable.Set(Channel, Name); }
...
LogCollector::LogCollector() { m_LocalInstance = false; }
...
bool LogCollector::IsRunning() { return static_cast<bool>(s_Instance.m_Impl); }
